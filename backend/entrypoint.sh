...
if tables_exist and not alembic_exists:
    ...
    known = {'001_initial', '002_currency', '003_exchange_rate', '004_debit_card_currency', '005_installment_payment_tracking', '006_add_transfers', '007_reimbursement_income', '008_add_savings_cards'}
